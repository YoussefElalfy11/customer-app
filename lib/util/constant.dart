...
class AppColor {
  static const Color primaryColor = Color(0xffFFC100);
  static const Color primaryBackgroundColor = Color(0xffFFFBFB);
  static const Color loginButtonColor = Color(0xffFFC100);
  ...
  static const Color viewAllbg = Color(0xffFFF3CD);
...
class Images {
  static String get logo => 'assets/images/app_logo2.png';

  static String get appLogo => 'assets/images/app_logo2.png';

  static String get splashLogo => 'assets/images/app_logo2.png';
