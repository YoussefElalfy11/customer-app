...
class CartController extends GetxController {
  ...
  calculateDistance(lat1, lon1, lat2, lon2) {
    deliveryCharge =
        int.parse(splash.configData.orderSetupBasicDeliveryCharge.toString())
            .toDouble();
    // deliveryCharge = 0.0;
    ...
    //print('distance ----------------------- ${kilometer.toStringAsFixed(2)}');
  }
  ...
  distanceWiseDeliveryCharge() {
    ...
    deliveryCharge =
        int.parse(splash.configData.orderSetupBasicDeliveryCharge.toString())
            .toDouble();
    double chargePerKm =
        int.parse(splash.configData.orderSetupChargePerKilo.toString())
            .toDouble();

    maxFreeDistance =
        int.parse(splash.configData.orderSetupFreeDeliveryKilometer.toString())
            .toDouble();
    if (maxFreeDistance <= kilometer) {
      ...
      //return deliveryCharge + extraCharge;

      //deliveryCharge += 2 * (kilometer - 1);
